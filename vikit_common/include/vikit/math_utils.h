...
Vector3d triangulateFeatureNonLin(const Eigen::Matrix3d& R, const Vector3d& t,
...
bool depthFromTriangulationExact(const Eigen::Matrix3d& R_r_c,
                                 const Vector3d& t_r_c, const Vector3d& f_r,
                                 const Vector3d& f_c, double& depth_in_r,
                                 double& depth_in_c);
...
double computeInliers(const vector<Vector3d>& features1,
                      ...
                      const Eigen::Matrix3d& R, const Vector3d& t,
                      const double reproj_thresh, double error_multiplier2,
                      vector<Vector3d>& xyz_vec, vector<int>& inliers,
                      vector<int>& outliers);
...
double sampsonusError(const Vector2d& v2Dash,
                      const Eigen::Matrix3d& m3Essential, const Vector2d& v2);
